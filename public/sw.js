 ...
 */
const VERSION = "catcare-v3";
// 一律用相對路徑：主站的 sw.js 在網域根目錄，Pages 版在 /CatCare2/ 底下，
// 相對路徑會各自對到正確的位置，絕對路徑在 Pages 上會全部 404 讓 install 失敗。
const PRECACHE = ["offline.html", "manifest.webmanifest", "icon-192.png", "icon-512.png", "icon-maskable-512.png"];
// 只有這些公開檔案可以在執行期進快取，比對檔名才不會被路徑前綴影響。
const RUNTIME = /\/(food-nutrition\.json|cat-[a-z]+\.jpg|favicon\.svg|icon-[a-z0-9-]+\.png)$|\/companion-cats\/.+\.(png|json)$/;
